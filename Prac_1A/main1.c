...
static void MX_TIM16_Init(void)
{
  ...
  htim16.Init.Prescaler =3999; // insert your psc value
  htim16.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim16.Init.Period =1999;         // insert your calculated period or ARR
...
/*Insert PB0 initialization code*/
	/* Enable GPIOB clock */
	    ...
	    GPIOB->MODER &= ~(3U << (0 * 2));   // Clear mode bits
	    GPIOB->MODER |=  (1U << (0 * 2));   // Set PB0 to output mode
